...
#define array_extend(self, count, contents)                                    \
    _array__splice(                                                            \
        (Array*)(self), array_elem_size(self), (self)->size, 0, count,         \
        contents                                                               \
    )
...
#define array_splice(self, _index, old_count, new_count, new_contents)         \
    _array__splice(                                                            \
        (Array*)(self), array_elem_size(self), _index, old_count, new_count,   \
        new_contents                                                           \
    )
...
#define array_insert(self, _index, element)                                    \
    _array__splice(                                                            \
        (Array*)(self), array_elem_size(self), _index, 0, 1, &(element)        \
    )
...
static inline void _array__splice(
    Array* self, size_t element_size, uint32_t index, uint32_t old_count,
    ...
    if (new_count > 0) {
        if (elements) {
            memcpy(
                (contents + index * element_size), elements,
                new_count * element_size
            );
        } else {
            memset(
                (contents + index * element_size), 0, new_count * element_size
            );
        }
    }
...
#define _array__search_sorted(                                                 \
    self, start, compare, suffix, needle, _index, _exists                      \
)                                                                              \
    do {                                                                       \
        *(_index) = start;                                                     \
        *(_exists) = false;                                                    \
